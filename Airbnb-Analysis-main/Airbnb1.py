...
with col1:
        image1 = Image.open("C:/Users/samue/Downloads/OIP.jpg")
        st.image(image1, width=300)
        
with col2:
    col2.subheader("NAME : SAMUEL SOLOMON")
    col2.subheader("EMAIL: Samuelrosy0210@gmail.com")
    col2.subheader("BATCH : D72D73")